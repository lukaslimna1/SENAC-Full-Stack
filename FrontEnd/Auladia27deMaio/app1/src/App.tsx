  ...
  return (
    ...
    <nav>
        <ul>
            ...
            <li><a href="#cursos">Cursos Complementares</a></li>
    ...
    <section id="contato">
        <h2>Contato</h2>
        <p>Email: <a href="mailto:lucasmslima1@gmail.com">lucasmslima1@gmail.com</a></p>
        ...
        <p>Linktree: <a href="https://linktr.ee/lucasmslima">https://linktr.ee/lucasmslima</a></p>
    </section>
    ...
    <section id="cursos">
        ...
        <ul className="lista-cursos">
            ...
            <li>
                <span className="titulo-curso">Santander Coders 2023.2 - Web Front-End</span>
            ...
            <li>
                <span className="titulo-curso">Técnico em Assistente de Produção Gráfica</span>
                <span className="instituicao">SENAC Bauru</span>
                <span className="situacao">(Concluído)</span>
            </li>
            <li>
